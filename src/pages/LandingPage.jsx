...
const Landingpage = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex items-center justify-center gap-10 mt-4 md:mt-6 ">
        <img
          src={excelLogo}
          alt="Excel Logo"
      ...
      <div className="relative text-center mt-24">
        {" "}
        {/* Relative positioning to make the image overlap */}
        ...
        <h2 className="relative text-4xl md:text-5xl font-bold z-10">
          {" "}
          {/* Relative to keep it above the image */}
          <span className="text-[#35374E]">EXQUISITE COMPUTER</span>{" "}
          <span className="text-[#0C9E8F]">ENGINEERS LEAGUE</span>
        </h2>
        <p className="relative text-lg md:text-xl text-gray-600 mt-4 z-10">
          {" "}
